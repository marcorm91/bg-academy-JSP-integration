		...
		if(hs.getAttribute("identificacion") == null  || !datos_gestor[1].equals("G")){  
			...
			try{
				...
				try{
					...
					new Chunk();
					par2.add(Chunk.TABBING);
					par2.add(new Phrase(datos_gest[2].toString(), datos));
					...
					new Chunk();
					par2.add(Chunk.TABBING);
					par2.add(new Phrase(datos_gest[3].toString() +" "+ datos_gest[4].toString(), datos));
					...
					par2.add(Chunk.TABBING);
					par2.add(Chunk.TABBING);
					par2.add(new Phrase(datos_gest[9].toString(), datos));
					...
					par4.add(Chunk.TABBING);
					par4.add(Chunk.TABBING);
					par4.add(new Phrase(datos_gest[0].toString(), datos));
					...
					String fechaoriginal_alta = datos_gest[7].toString(); 
					...
					par4.add(Chunk.TABBING);
					par4.add(Chunk.TABBING);
					par4.add(new Phrase(datos_gest[8].toString(), datos));
					...
					par4.add(Chunk.TABBING);
					par4.add(Chunk.TABBING);
					par4.add(new Phrase(datos_gest[10].toString(), datos));
					...
					par5.add(Chunk.TABBING);
					par5.add(new Phrase(datos_gest[5].toString(), datos));
					par5.add(new Phrase(Chunk.NEWLINE));
					
					par5.add(new Phrase("Contraseña: ", datos));
					par5.add(Chunk.TABBING);
					par5.add(Chunk.TABBING);
					par5.add(new Phrase(datos_gest[6].toString(), datos));
