...
public class Ver_tareas extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(hs.getAttribute("log") == null || !datos_alumn[1].equals("A")){
			...
			// Llamamos al modelo para realizar la consulta sobre las tareas en la BD pasándole
			// como parámetros el año de promoción y el curso asignado del alumno y a qué tipo de
			// actividad se referirá, en este caso Tarea.
			actividades = modelo_actividades.dameActividades(anioprom, cursoasign, "T");
