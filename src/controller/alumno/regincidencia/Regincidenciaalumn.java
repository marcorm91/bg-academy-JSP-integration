...
/**
 * Clase controladora - Se encargará de registrar una incidencia por parte del usuario Alumno.
 */
     ...
     // Comprobamos que la session no sea null o que el tipo de usuario sea de tipo Alumno...
		if(hs.getAttribute("log") == null || !datos_alumn[1].equals("A")){
			...
			try{
				...
				// Recogemos el texto que nos envía el usuario (alumno) de la incidencia y su ID.
