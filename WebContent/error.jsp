...
<body>
		...
		<div id="contenedorAcceso" class="col-xs-12">
			<div class="container-fluid text-xs-center contenedorError">
				<img src="${request.contextPath}/assets/imagenes/error.png" class="img-fluid">

				<p id="atrasError"> <a href="${request.contextPath}/index.jsp" title="Volver a Inicio">VOLVER A INICIO</a></p>
			</div>
		</div>
</body>
</html>