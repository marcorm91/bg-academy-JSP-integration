                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="nav-item">
                         ...
                         <li class="nav-item hidden-md-down" id="conectadoComo">  
                            <span class="nav-link">
                                Conectado como 
                                <span id="quien" title="Ir a Mi Perfil"> <a href="./noticiario/mi-perfil.jsp"> <% out.print(datos_not[2]); %> </a> </span>
...
<div id="md-welcome" title="¡Bienvenido!" style='display: none;'>	
	...
	<hr/>
	<p> Hola <% out.print(datos_not[2]); %>, </p>
	...
	<p> Te aconsejamos que antes de empezar, utilices la <a class="text-primary" href="./noticiario/ayuda.jsp" target="_blank">Ayuda</a> de la academia. </p>
